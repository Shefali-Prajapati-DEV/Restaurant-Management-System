...
from .api_views import CategoryAPIView, MenuAPIView
from.api_views import RegisterAPIView
from.api_views import LoginAPIView
from.api_views import AddToCartView
...
urlpatterns = [
    ...
    path('api/cart/', AddToCartView.as_view(), name='cart'),
    path('api/cart/item/<int:id>/', AddToCartView.as_view(), name='cart-item'),
    path('api/cart/clear/', AddToCartView.as_view(), name='clear-cart'),
